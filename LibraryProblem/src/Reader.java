...
public class Reader extends Thread {
    ...
    private final static int MIN_READ_TIME = 5000;
    private final static int MAX_READ_TIME = 15000;
    ...
    public void run() {
        try {
            for (int i = 0; i < NUM_BOOKS; ++i) {
                int book = chooseRandomBook();
                withdrawBook(book);
                enthusiasticallyReadBook(book);
    ...
    private void enthusiasticallyReadBook(int book) throws InterruptedException {
